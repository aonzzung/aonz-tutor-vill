...
function jfb_output_facebook_btn()
{
    ...
    {
        ?><span class="fbLoginButton"><script type="text/javascript">//<!--
            document.write('<fb:login-button scope="<?php echo $scope ?>" v="2" size="xlarge" onlogin="<?php echo $jfb_js_callbackfunc ?>();"><?php echo apply_filters('wpfb_button_text', 'Signup with Facebook') ?></fb:login-button>');
        //--></script></span><?php
    }
